...
async def main():
    config.model_settings = ModelSettings(tool_choice="required") # Key setting we're testing
    ...
    try:
        ...
        print("This confirms the agent entered an infinite loop because tool_choice remained 'required'")
